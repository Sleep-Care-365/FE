        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
          ...
          <div className="flex-1 text-center md:text-left space-y-6">
            ...
            <p className="text-lg text-slate-600 leading-relaxed max-w-lg mx-auto md:mx-0">
              오늘 밤 수면이 궁금하신가요? <br />
              웨어러블 데이터를 업로드하고 <strong>AI 코칭</strong>을
              받아보세요.
            </p>
          ...
          <div className="flex-1 flex justify-center">
            <div className="relative">
              ...
              {/* 💡 [수정] 변수 대신 public 폴더 루트에 위치한 정식 PNG 파일을 문자열 경로로 직접 찌릅니다. */}
              <img
                src="/moon-icon.png"
                alt="Sleep Care Moon"
...
const FeatureCard = ({ to, icon, iconBg, title, desc }: any) => (
  ...
  >
    <div className="flex items-start gap-4">
      <div
        className={`p-3 rounded-xl shadow-md ${iconBg} group-hover:scale-110 transition-transform duration-300`}
      >
        {icon}
      </div>
